 ...
 */
class NegotiationUrlPrefixForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'br_domain_language_negotiation_configure_url_prefix_form';
  }
  ...
  protected function getEditableConfigNames() {
    return ['br_domain.language.negotiation'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    global $base_url;
    $config = $this->config('br_domain.language.negotiation');
    ...
    $form_state->setRedirect('br_domain.language.negotiation');
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    $default_langcode = $this->config('br_domain.language.negotiation')->get('selected_langcode');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('br_domain.language.negotiation')
